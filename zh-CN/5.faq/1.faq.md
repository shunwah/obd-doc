...
您可在部署配置文件中使用版本声明。例如，如果您使用的是 OceanBase-CE 3.1.0 版本，(注意在version: 3.1.0前面加空格)可以指定以下配置：
...
由于开源 OBProxy 组件正式更名为 obproxy-ce，所以您需在 OBD 的执行用户下 [执行脚本](../5.faq/2.how-to-upgrade-obproxy-to-obproxy-ce-3.2.3.md/#执行脚本) 修改 meta 信息。而后使用以下命令进行升级。
